...
export default class LoginScreen extends React.Component  {
  render(){
    ...
    return(
      ...
      <Text style={{fontSize:45,color:'gray',textAlign:'center',marginHorizontal:20}} >Welcome</Text>
      ...
      marginHorizontal:10,alignItems:'center',justifyContent:'center'}}><Text style={{fontSize:20,fontWeight:'bold',color:'#FFF'}}>G</Text></View>
        <View style={{height:40,width:40,borderRadius:40/2,backgroundColor:'#1565c0',alignItems:'center',justifyContent:'center'}}>
          <Text style={{fontSize:20,fontWeight:'bold',color:'#FFF'}}>in</Text></View>
      </View>
    </View>
    )
  }
